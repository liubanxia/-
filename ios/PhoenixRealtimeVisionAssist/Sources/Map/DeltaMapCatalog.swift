...
enum DeltaMapCatalog {
    static let all: [MapCatalogEntry] = [
        ...
        MapCatalogEntry(id: .layaliGrove, displayName: "Layali Grove / 长弓溪谷", learningPriority: 3),
        MapCatalogEntry(id: .brakkesh, displayName: "Brakkesh / 巴克什", learningPriority: 4),
        MapCatalogEntry(id: .tidePrison, displayName: "Tide Prison / 潮汐监狱", learningPriority: 5)
    ]
}
