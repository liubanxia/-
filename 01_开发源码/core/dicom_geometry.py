...
def world_lps_to_pixel(
    ...
    """Map DICOM patient LPS coordinates to image (x, y) and plane offset in mm."""
    ...
    # First IOP vector points along image columns (x); second along rows (y).
